...
#trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=args.shuffle, sampler = trainset.pruning_sampler())
trainloader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=args.shuffle)
...
fn = '{}{}-{}-epoch{}-batchsize{}-pct{}-labelsm{}-{}_cifar100_Wholeset_log.json'.format(
                                                                args.model,
...
file = open(fn,'w+')
json.dump([total_time,args.ratio,train_acc,valid_acc],file)
